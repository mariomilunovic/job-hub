...
<form action="{{route('login.login')}}" method="post" autocomplete="off">
    ...
    <input type="text" autocomplete="false" id="email" name="email" placeholder="Unesi email adresu" value="{{old('email')}}" class="w-full px-4 py-2 leading-tight text-gray-700 bg-gray-200 border-2 border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-purple-500">
