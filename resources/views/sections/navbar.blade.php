<div class="flex flex-col mt-5 font-semibold justify-items-center text-md">
    ...
    <div x-data="{ expanded_poslovi: $persist(false) }">
        ...
        <div x-show="expanded_poslovi" x-collapse class="text-sm text-center text-white bg-neutral-600" x-cloak>
    ...
    <div x-data="{ expanded_vestine: $persist(false) }">
        ...
        <div x-show="expanded_vestine" x-collapse class="text-sm text-center text-white bg-neutral-600" x-cloak>
    ...
    <div x-data="{ expanded_novac: $persist(false)}">
        ...
        <div x-show="expanded_novac" x-collapse class="text-sm text-center text-white bg-neutral-600" x-cloak>
    ...
    <div x-data="{ expanded_korisnici: $persist(false) }">
        ...
        <div x-show="expanded_korisnici" x-collapse class="text-sm text-center text-white bg-neutral-600" x-cloak>
