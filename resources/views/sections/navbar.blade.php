<div class="flex flex-col justify-between flex-1 my-2">
    <nav>
        <div x-data="{ expanded_poslovi: $persist(false) }">
            <a @click="expanded_poslovi = !expanded_poslovi"  class="flex justify-center py-2 menu_item gradient_blue" href="#">
        ...
        <div x-data="{ expanded_ponude: $persist(false) }">
            <a @click="expanded_ponude = !expanded_ponude" class="flex justify-center py-2 menu_item gradient_blue" href="#">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div x-data="{ expanded_vestine: $persist(false) }">
            <a @click="expanded_vestine = !expanded_vestine" class="flex justify-center py-2 menu_item gradient_blue" href="#">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div x-data="{ expanded_novac: $persist(false) }">
            <a @click="expanded_novac = !expanded_novac" class="flex justify-center py-2 menu_item gradient_blue" href="#">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div x-show="expanded_novac" @click.outside="expanded_novac = false" x-collapse x-cloak class="text-sm text-center submenu_item">
                @if(auth()->user())
                <a class="submenu_text" href="{{route('transaction.index',auth()->user())}}">Transakcije</a>
                @endif
                <a class="submenu_text" href="{{route('transaction.deposit')}}">Uplata</a>
                <a class="submenu_text" href="{{route('transaction.withdraw')}}">Isplata</a>
            </div>
        </div>

        <div x-data="{ expanded_korisnici: $persist(false) }">
            <a @click="expanded_korisnici = !expanded_korisnici" class="flex justify-center py-2 menu_item gradient_blue" href="#">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
