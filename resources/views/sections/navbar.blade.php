    ...
    <div :class="{ 'block' : expanded_all , 'hidden' : !expanded_all}" class="sm:flex" x-cloak>
            ...
            <nav class="flex-col py-2 w-full">
                <div x-data="{ expanded_poslovi: $persist(false) }" class="">
                    <a @click="expanded_poslovi = !expanded_poslovi"  class="flex  py-2  menu_item" href="#">
                ...
                <div x-data="{ expanded_ponude: $persist(false) }">
                    <a @click="expanded_ponude = !expanded_ponude" class="flex  py-2 menu_item" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div x-data="{ expanded_vestine: $persist(false) }">
                    <a @click="expanded_vestine = !expanded_vestine" class="flex  py-2 menu_item" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div x-show="expanded_vestine"  x-collapse x-cloak class="text-sm  submenu_item">
                ...
                <div x-data="{ expanded_novac: $persist(false) }">
                    <a @click="expanded_novac = !expanded_novac" class="flex  py-2 menu_item" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div x-show="expanded_novac" x-collapse x-cloak class="text-sm  submenu_item">
