    ...
    <table class="p-6 table-auto">
        ...
        <tbody class="text-sm">
            ...
            <tr>
                ...
                <td class="px-4 py-2 whitespace-nowrap">
                    <a href="{{route('users.show',$user)}}" class="w-full px-4 font-bold text-white bg-purple-500 rounded shadow hover:bg-purple-400 focus:shadow-outline focus:outline-none">Prikaži</a>
                </td>
            </tr>
