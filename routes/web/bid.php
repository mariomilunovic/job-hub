...
Route::get('/bid/create',[BidController::class,'create'])->name('bid.create')->middleware('check_roles:administrator');
Route::get('/bid/{bid}',[BidController::class,'show'])->name('bid.show')->middleware('check_roles:administrator');
